...
// Planning Constants
// chose a value between 5 and 7 as suggested in the course
...
// chose an odd number with value bigger than in the course exercise (there was 9)
#define P_NUM_POINTS_IN_SPIRAL 13      // TODO - Num of points in the spiral
